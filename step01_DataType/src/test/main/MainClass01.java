...
public static void main(String[] args) {
	...
	float num1 = 10.1f;
	double num2 = 10.2d;
	double num3 = 10.3; //d,f를 붙이지 않으면 double type으로 간주한다.
	
	//상수를 만들때는 final이라는 예약어를 추가로 붙여준다
	final int num = 10;
	//num=20;//type이 맞아도 변경불가
	final double myNum = 10.1;
	//myNum =10.2//type이 맞아도 변경불가
